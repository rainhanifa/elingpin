...
<body>
    ...
    //////////////////////////////////////////////////////////////////
        ...
        if($_SESSION['user'] <> $_GET['user']){
            ...
            header("location:http://localhost:8080/elprowinmvc.com/epsettings/siswa/public/js/codiad/index.php?user=$_GET[user]");
        }else{
    ?>
    ...
    <div id="workspace">
        ...
        <div id="editor-region">
            ...
            <div id="root-editor-wrapper"><?php //echo $_SESSION['user'];echo $_GET['user']; ?></div>
